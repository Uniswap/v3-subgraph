...
export class Pool__burn1Result {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__collect1Result {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__mint1Result {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__periodsResult {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: BigInt;

  constructor(value0: BigInt, value1: i32, value2: i32, value3: BigInt) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
    this.value3 = value3;
  ...
  getEndSecondsPerLiquidityPeriodX128(): BigInt {
    return this.value3;
  }
}
...
export class Pool extends ethereum.SmartContract {
  ...
  burn(
    ...
    let result = super.call(
      "burn",
      "burn(uint256,int24,int24,uint128):(uint256,uint256)",
      [
  ...
  burn1(tickLower: i32, tickUpper: i32, amount: BigInt): Pool__burn1Result {
    let result = super.call(
      "burn",
    ...
    return new Pool__burn1Result(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_burn1(
    ...
    tickUpper: i32,
    amount: BigInt,
  ): ethereum.CallResult<Pool__burn1Result> {
    let result = super.tryCall(
      "burn",
      "burn(int24,int24,uint128):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__burn1Result(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  collect1(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt,
  ): Pool__collect1Result {
    let result = super.call(
      "collect",
      "collect(address,uint256,int24,int24,uint128,uint128):(uint128,uint128)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromUnsignedBigInt(index),
        ethereum.Value.fromI32(tickLower),
    ...
    return new Pool__collect1Result(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_collect1(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt,
  ): ethereum.CallResult<Pool__collect1Result> {
    let result = super.tryCall(
      "collect",
      "collect(address,uint256,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__collect1Result(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  currentFee(): i32 {
    let result = super.call("currentFee", "currentFee():(uint24)", []);

    return result[0].toI32();
  }

  try_currentFee(): ethereum.CallResult<i32> {
    let result = super.tryCall("currentFee", "currentFee():(uint24)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  lastPeriod(): BigInt {
    let result = super.call("lastPeriod", "lastPeriod():(uint256)", []);

    return result[0].toBigInt();
  }

  try_lastPeriod(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lastPeriod", "lastPeriod():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  mint1(
    ...
    let result = super.call(
      "mint",
      "mint(address,uint256,int24,int24,uint128,bytes):(uint256,uint256)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromUnsignedBigInt(index),
        ethereum.Value.fromI32(tickLower),
    ...
    return new Pool__mint1Result(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_mint1(
    ...
    amount: BigInt,
    data: Bytes,
  ): ethereum.CallResult<Pool__mint1Result> {
    let result = super.tryCall(
      "mint",
      "mint(address,uint256,int24,int24,uint128,bytes):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__mint1Result(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  periodCumulativesInside(
    ...
    let result = super.call(
      "periodCumulativesInside",
      "periodCumulativesInside(uint32,int24,int24):(uint160)",
      [
  ...
  periods(period: BigInt): Pool__periodsResult {
    let result = super.call(
      "periods",
      "periods(uint256):(uint32,int24,int24,uint160)",
      [ethereum.Value.fromUnsignedBigInt(period)],
    );

    return new Pool__periodsResult(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_periods(period: BigInt): ethereum.CallResult<Pool__periodsResult> {
    let result = super.tryCall(
      "periods",
      "periods(uint256):(uint32,int24,int24,uint160)",
      [ethereum.Value.fromUnsignedBigInt(period)],
  ...
  positionPeriodDebt(
    ...
    let result = super.call(
      "positionPeriodDebt",
      "positionPeriodDebt(uint256,address,uint256,int24,int24):(int256)",
      [
        ethereum.Value.fromUnsignedBigInt(period),
  ...
  positionPeriodSecondsInRange(
    ...
    let result = super.call(
      "positionPeriodSecondsInRange",
      "positionPeriodSecondsInRange(uint256,address,uint256,int24,int24):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(period),
        ethereum.Value.fromAddress(owner),
        ethereum.Value.fromUnsignedBigInt(index),
  ...
  try_positionPeriodSecondsInRange(
    period: BigInt,
    owner: Address,
    index: BigInt,
    tickLower: i32,
  ...
  readStorage(slots: Array<Bytes>): Array<Bytes> {
    let result = super.call(
      "readStorage",
      "readStorage(bytes32[]):(bytes32[])",
  ...
  try_readStorage(slots: Array<Bytes>): ethereum.CallResult<Array<Bytes>> {
    let result = super.tryCall(
      "readStorage",
      "readStorage(bytes32[]):(bytes32[])",
      [ethereum.Value.fromFixedBytesArray(slots)],
  ...
  try_tickBitmap(tick: i32): ethereum.CallResult<BigInt> {
