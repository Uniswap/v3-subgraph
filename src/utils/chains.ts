  ...
  if (selectedNetwork == ARBITRUM_ONE_NETWORK_NAME) {
    ...
    return {
      ...
      tokenOverrides: [
        ...
        {
          address: Address.fromString('0x01a4b3221e078106f9eb60c5303e3ba162f6a92e'),
          symbol: 'USBD',
        ...
        {
          address: Address.fromString('0x4bf883a30aa7883b49d810426edc42187dad32e4'),
          symbol: 'NOICE',
          name: 'Noice',
          decimals: BigInt.fromI32(18),
        },
        ...
        {
          address: Address.fromString('0x87d089ff822b42827c9ee044530438c3c2464a33'),
          symbol: 'ROY',
          name: 'ROY',
          decimals: BigInt.fromI32(18),
        },
