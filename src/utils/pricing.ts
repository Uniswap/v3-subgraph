...
export const USDB_WETH_03_POOL = '0xf52b4b69123cbcf07798ae8265642793b2e8990c'
...
export const STABLE_COINS: string[] = [USDB_ADDRESS]
...
export function getEthPriceInUSD(
  stablecoinWrappedNativePoolAddress: string = USDB_WETH_03_POOL,
